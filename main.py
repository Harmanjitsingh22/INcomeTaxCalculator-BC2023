...
from nstatistics import mean, standardDeviation, median, computeModes
...
def _main_() :
    ...
    fileName = 'https://github.com/Harmanjitsingh22/INcomeTaxCalculator-BC2023/blob/main/salaries'
    extension = 'xls'
